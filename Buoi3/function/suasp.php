...
<body>
    <table>
        ...
        <tr>
            <td>
                <form method="POST" action="editProduct.php?product=<?php echo $_GET['product']; ?>" id="form" enctype="multipart/form-data">
                    <table id="tb1">
                        <tbody>
                            ...
                            <tr>
                                <td>Ten San Pham</td>
                                <td>
                                    <input id="account" name="nameProduct" value="<?php echo $tensp ?>" type="text">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <textarea id='chitietsanpham' value="" name='ctsp' rows="4" cols="50"><?php echo $ctsp ?></textarea>
                                </td>
                                <td></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input id="gia" type='number' value="<?php echo $gia ?>" name="gia">(VND)
                            ...
                            <tr>
                                <td></td>
                                <td>
                                    <button id="btn_submit" type="submit">Update</button>
